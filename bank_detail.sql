...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 27, 2021 at 10:10 AM
...
INSERT INTO `bank_detail` (`bank_id`, `bank_name`) VALUES
('AACX', 'Akhand Anand Co.op Bank'),
('ABBL', 'AB Bank'),
('ABCX', 'Aurangabad District Central Co-operative Bank'),
('ABDX', 'Dr. Ambedkar Nagrik Sahakari Bank Mydt Gwalio'),
...
('AHUX', 'Ahilyadevi Urban Co-operative Bank Limited So'),
...
('ARCX', 'Arunachal Pradesh State Co-operative Apex Ban'),
('ARMX', '510 Army Base W/s Credit Co-operative Primary'),
...
('AURX', 'Aurangabad District Central Co-operative Bank'),
...
('AZPX', 'Amravati Zilla Parishad Shikshak Sahakari Ban'),
...
('BBUX', 'Bellad Bagewadi Urban Souharada Sahakari Bank'),
...
('BDOX', 'Banda District Co-operative Bank Limited Band'),
...
('BRUX', 'Bharuch District Central Co-operative Bank Bh'),
...
('CIDX', 'Chikmagalur District Central Co-operative Ban'),
('CITI', 'CITI Bank'),
('CITX', 'Chitradurga District Co-operative Central Ban'),
...
('CRUB', 'Shri Chhatrapati Rajashri Shahu Urban Co-oper'),
...
('CTUX', 'Chittorgarh Urban Co-operative Bank Chittorga'),
...
('DCCX', 'District Co-operative Central Bank Mahabubnag'),
('DCDX', 'District Central Co-operative Bank Limited El'),
...
('DDDX', 'Dakshin Dinajpur District Central Co-operativ'),
...
('DICG', 'Deposit Insurance and Credit Guarantee Corpor'),
('DICX', 'District Co-operative Central Bank Visakhapat'),
('DIUX', 'Dilip Urban Co-operative Bank'),
('DJCX', 'Deoghar Jamtara Central Co-operative Bank Deo'),
...
('DMKB', 'Dattatraya Maharaj Kalambe Jaoli Sahakari Ban'),
('DMKJ', 'Dmk Jaoli Bank'),
('DNDC', 'Dhule And Nandurbar District Central Co-opera'),
('DNSB', 'Dombivli Nagari Sahakari Bank'),
('DNSX', 'Deendayal Nagari Sahakari Bank'),
('DOBX', 'Dapoli Urban Co-operative Bank Dapoli'),
('DOHB', 'Doha Bank QSC'),
('DRGX', 'Durg Rajnandgaon Gramin Bank (merged With Chh'),
...
('FDFX', 'Farrukhabad District Co-operative Bank Fatehg'),
('FDRL', 'Federal Bank'),
...
('JICX', 'Jila Sahakari Kendriya Bank Maryadit Chhindwa'),
...
('JKMX', 'Jila Sahakari Kendriya Bank Maryadit Jagdalpu'),
...
('JRNX', 'Jila Sahakari Kendriya Bank Maryadit Rajnandg'),
...
('JTSX', 'Jugalkishor Tapdiya Shree Mahesh Ucb Aurangab'),
...
('KAIJ', 'Kallappanna Awade Ichalkaranji Janata Sahakar'),
...
('KAYX', 'Kanyakumari District Central Co-operative Ban'),
...
('KPCX', 'Kolhapur Dist.central Co-operative Bank Kolha'),
('KRCX', 'Kolar And Chickballapur Dt Co-operative Centr'),
...
('KYDX', 'Kalaburagi and Yadgir Dist Co-operative Centr'),
...
('MAHX', 'Shree Mahalaxmi Urban Co-operative Credit Ban'),
...
('MDPX', 'Md Pawar Peoples Co-operative Bank Urun Islam'),
...
('MHEX', 'Mahamedha Urban Co-operative Bank ( Under Rbi'),
...
('MMCX', 'Mattancherry Mahajanik Co-operative Urban Ban'),
('MMMX', 'Mahila  Nagrik Sahakari Bank Maryadit Mahasam'),
...
('MUDX', 'Madheshwari Urban Development Co-operative Ba'),
('MUNX', 'Mahudha Nagarik Sahakari Bank'),
('MUPX', 'Mehmadabad Urban Peoples Co-operative Bank'),
('MURX', 'Murshidabad District Central Co-operative Ban'),
...
('MYSX', 'Mysore Chamarajanagar District Co-operative B'),
...
('NDGX', 'Nashik District Girna Sahakari Bank( Under Rb'),
('NDIX', 'Nashik District Industrial & Mercantile Co-op'),
...
('NPKX', 'Nashik Zilha Sarkari & Parishad Karmachari Sb'),
('NRDX', 'Nasik Road Deolali Vyapari Sahakari Bank'),
('NRMX', 'Northern Railway Multi State Primary Co-opera'),
...
('PCPX', 'Pimpri Chinchwad Sahakari Bank Maryadit,pimpr'),
...
('PVVX', 'Padmashri Dr. Vitthalrao Vikhe Patil Co-opera'),
...
('RSVX', 'Rajarshi Shahu Govt Servants Co-operative Ban'),
...
('SADX', 'Sabarkantha District Central Co-operative Ban'),
...
('SBKX', 'Sri Channabasavaswamy Souhardha Pattana Sahak'),
('SBLD', 'Sonali Bank'),
...
('SBUJ', 'Shri Bharat Urban Co-operative Bank Jaysingpu'),
...
('SCDX', 'South Canara District Central Co-operative Ba'),
...
('SDCX', 'Sindhudurg  District Central Co-operative Ban'),
...
('SEMX', 'Secunderabad Mercantile Co-operative Urban Ba'),
...
('SGUX', 'Sadguru Gahininath Urban Co-operative Bank Ak'),
...
('SNSV', 'Sarakari Naukarara Sahakari Bank Niyamt Vijay'),
...
INSERT INTO `bank_detail` (`bank_id`, `bank_name`) VALUES
('SPSX', 'Sandur Pattana Souharda Sahakari Bank Niyamit'),
...
('SURX', 'Siddheshwar Urban Co-operative Bank Maryadit '),
...
('TASX', 'Annasaheb Savant Co-operative Urban Bank Maha'),
...
('TIDX', 'Thiruvannamalai District Central Co-operative'),
('TIRX', 'Tirunelveli District Central Co-operative Ban'),
('TJAX', 'Jaisalmer Central Co-operative Bank'),
('TJBX', 'Janata Co-operative Bank Sadalga'),
('TJCX', 'Thanjavur Central Co-operative Bank'),
('TJDX', 'Jalgaon District Central Co-operative Bank Ja'),
...
('TPUX', 'Urban Co-operative Bank No 1758 Perinthalmann'),
...
('TUPX', 'Uttarsanda Peoples Co-operative Bank Uttarsan'),
('TURX', 'Tura Urban Co-operative Bank'),
('TVBX', 'Vellala Co-operative Bank'),
('TVDX', 'District Co-operative Central Bank Vizianagar'),
...
('UMSX', 'Udaipur Mahila Samridhi Urban Co-operative Ba'),
...
('VIRX', 'Virudhunagar District Central Co-operative Ba'),
...
('WARX', 'Warangal District Co-operativeerative Central'),
...
('WZUX', 'Wardha Zilla Parishad Emp Urban Co-operative '),
...
('YESB', 'Yes Bank'),
('YLNX', 'Yadagiri Lakshmi Narsimha Swamy Co-operative '),
